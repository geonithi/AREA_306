...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5515869.106020, 2929436.996103, 5732030.301077, 3064458.505038], maxZoom: 28, minZoom: 9
    })
});
...
map.getView().fit([5515869.106020, 2929436.996103, 5732030.301077, 3064458.505038], map.getSize());
